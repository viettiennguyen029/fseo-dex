...
export default function Home() {
  ...
  */
      ...
      return (
        <div>
          <div className={styles.description}>
            ...
            {utils.formatEther(cdBalance)} FSEO Tokens
            <br />
            {utils.formatEther(ethBalance)} Ether
            <br />
            {utils.formatEther(lpBalance)} FSEO LP tokens
          </div>
          <div>
            ...
            {utils.parseEther(reservedCD.toString()).eq(zero) ? (
              <div>
                ...
                <input
                  type="number"
                  placeholder="Amount of FSEO tokens"
                  onChange={(e) =>
                    setAddCDTokens(
      ...
      return (
        <div>
          ...
          >
            ...
            <option value="cryptoDevToken">FSEO Token</option>
          </select>
          <br />
          <div className={styles.inputDiv}>
            {/* Convert the BigNumber to string using the formatEther function from ethers.js */}
  ...
  return (
    <div>
      <Head>
        <title>FSEO Exchange</title>
        <meta name="description" content="FSEO Exchange" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <div className={styles.main}>
        <div>
          <h1 className={styles.title}>Welcome to FSEO Exchange!</h1>
          <div className={styles.description}>
            Exchange Ethereum &#60;&#62; FSEO Tokens
          </div>
          <div>
            <button
